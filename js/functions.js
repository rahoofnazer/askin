      ...
      if ($inspiroSlider.length > 0) {
        ...
        function animate_captions($elem) {
          ...
          $captions.each(function (index) {
            var $captionElem = $(this),
              captionDelay = $captionElem.attr("data-caption-delay") || index * 0 + 0,
        ...
        $inspiroSlider.each(function () {
          ...
          elem.options = {
            ...
            autoPlay: elem.attr("data-autoplay") || 3200,
            // slider duration here//////////////////////////////////////////////////////////////////////////////
            ...
            playWholeVideo: elem.attr("data-play-whole-video") == false ? false : false
          }
          //Kenburns effect
          ...
          inspiroSliderData.on("select.flickity", function () {
            ...
            if (video) {
              video.play();
              flkty.options.autoPlay = Number(video.duration * 700);
